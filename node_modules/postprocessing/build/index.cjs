...
var EffectComposer = class {
   ...
   */
  createDepthTexture() {
    const inputDepthTexture = new import_three5.DepthTexture();
    inputDepthTexture.name = "EffectComposer.InputDepth";
    if (this.inputBuffer.stencilBuffer) {
      inputDepthTexture.format = import_three5.DepthStencilFormat;
      inputDepthTexture.type = import_three5.UnsignedInt248Type;
    } else {
      inputDepthTexture.type = import_three5.FloatType;
    }
    ...
    this.depthRenderTarget = new import_three5.WebGLRenderTarget(width, height, {
      depthBuffer: true,
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    ...
    const renderTarget = new import_three5.WebGLRenderTarget(size.width, size.height, {
