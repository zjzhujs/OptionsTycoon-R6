...
const FIELD_PALETTES: Record<FieldTheme, FieldPalette> = {
  ...
  amber: {
    primary: [0.12, 0.86, 1.00],
    secondary: [1.40, 0.68, 0.16],
    hot: [3.20, 2.62, 1.34],
    tissuePrimary: [0.10, 0.72, 0.84],
    tissueSecondary: [0.80, 0.40, 0.10],
    spine: [2.20, 1.08, 0.24],
    bloom: 1.30,
  },
  calm: {
    primary: [0.22, 0.78, 0.90],
    secondary: [0.38, 0.58, 0.92],
    hot: [1.72, 2.08, 2.18],
    tissuePrimary: [0.12, 0.52, 0.62],
    tissueSecondary: [0.16, 0.34, 0.58],
    spine: [0.88, 1.22, 1.48],
    bloom: 0.82,
  },
};
